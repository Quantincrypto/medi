...
const STATIC_PAGES = [
  ...
  { loc: '/ct-scanner-price-nigeria',                                 priority: '0.9', changefreq: 'monthly' },
  { loc: '/ultrasound-machine-price-nigeria',                         priority: '0.9', changefreq: 'monthly' },
  { loc: '/x-ray-machine-price-nigeria',                              priority: '0.9', changefreq: 'monthly' },
  { loc: '/mri-machine-price-nigeria',                                priority: '0.9', changefreq: 'monthly' },
  { loc: '/ct-scanner-price-south-africa',                            priority: '0.9', changefreq: 'monthly' },
  { loc: '/ultrasound-machine-price-south-africa',                    priority: '0.9', changefreq: 'monthly' },
  { loc: '/x-ray-machine-price-south-africa',                         priority: '0.9', changefreq: 'monthly' },
  { loc: '/mri-machine-price-south-africa',                           priority: '0.9', changefreq: 'monthly' },
  { loc: '/medical-equipment-suppliers-lagos',                        priority: '0.8', changefreq: 'weekly'  },
  { loc: '/medical-equipment-suppliers-accra',                        priority: '0.8', changefreq: 'weekly'  },
  { loc: '/refurbished-medical-equipment-tanzania-dar-es-salaam',     priority: '0.8', changefreq: 'weekly'  },
  { loc: '/refurbished-medical-equipment-zimbabwe-harare',            priority: '0.8', changefreq: 'weekly'  },

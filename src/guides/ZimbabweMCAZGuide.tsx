  ...
  <div className="space-y-12">
    ...
    <section>
      <div className="bg-teal/5 border border-teal/15 rounded-2xl p-6">
        ...
        <p className="text-sm text-navy/70 mb-4">Sourcing refurbished equipment for Zimbabwean hospitals? Browse ISO 13485-certified suppliers with MCAZ-compatible documentation.</p>
        <div className="flex flex-col gap-2">
          <Link to="/refurbished-medical-equipment-zimbabwe-harare" className="text-teal font-bold text-sm hover:underline">Refurbished Medical Equipment in Zimbabwe →</Link>
